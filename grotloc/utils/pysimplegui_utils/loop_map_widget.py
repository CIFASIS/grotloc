...
class ScatterMap3D(GUIWidget):
    ...
    def scatter_figure(self):
        ...
        lc = Line3DCollection(
            candidate_pairs_3d, linewidth=0.5, linestyles='solid', color=color)
    ...
    def step(self, window, event, values):
        ...
        if event == 'Plot':
            ...
            pysimplegui_pyplot_draw(window['figure'].TKCanvas, window['figure_controls'].TKCanvas, fig)
